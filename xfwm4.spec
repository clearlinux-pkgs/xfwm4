...
%prep
%setup -q -n xfwm4-4.16.0
cd %{_builddir}/xfwm4-4.16.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609289791
...
cp %{_builddir}/xfwm4-4.16.0/COPYING %{buildroot}/usr/share/package-licenses/xfwm4/73ccddd0c27b4492f8182c35f0f7c434b998757c
%make_install
%find_lang xfwm4
