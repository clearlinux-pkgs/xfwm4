...
Source0  : https://archive.xfce.org/src/xfce/xfwm4/4.18/xfwm4-4.18.0.tar.bz2
...
%prep
%setup -q -n xfwm4-4.18.0
cd %{_builddir}/xfwm4-4.18.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671135380
...
cp %{_builddir}/xfwm4-%{version}/COPYING %{buildroot}/usr/share/package-licenses/xfwm4/73ccddd0c27b4492f8182c35f0f7c434b998757c
%make_install
%find_lang xfwm4
...
/usr/share/package-licenses/xfwm4/73ccddd0c27b4492f8182c35f0f7c434b998757c
